...
if __name__ == "__main__":  # Prevent multiprocessing issues
    ...
    CHECKPOINT_PATH = os.path.join(CHECKPOINT_DIR, "noisy_resnet.pth")
    RESULTS_DIR = ROOT_DIR / "models" / "CNN_ResNet" / "results"
    RESULTS_PATH = os.path.join(RESULTS_DIR, "noisy_model_test_results.txt")
    CONF_MATRIX_PATH = os.path.join(RESULTS_DIR, "noisy_model_confusion_matrix.png")
    CONF_MATRIX_CSV_PATH = os.path.join(RESULTS_DIR, "noisy_model_confusion_matrix.csv")
    NOISE_RESULTS_PATH = os.path.join(RESULTS_DIR, "noisy_model_noise_test_results.txt")
    NOISE_CONF_MATRIX_PATH = os.path.join(RESULTS_DIR, "noisy_model_noise_confusion_matrix.png")
    NOISE_CONF_MATRIX_CSV_PATH = os.path.join(RESULTS_DIR, "noisy_model_noise_confusion_matrix.csv")
